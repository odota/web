...
export const player = {
  ...
  getProfile: (state, id) => player.getPlayer(state, id).profile,
  ...
  getPicture: (state, id) => player.getProfile(state, id).avatarmedium,
  getSteamLink: (state, id) => player.getProfile(state, id).profileurl,
  getCheese: (state, id) => player.getProfile(state, id).cheese,
};
