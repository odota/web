...
(function () {
    ...
    ***************************************************************************** */
    ...
    var messageSandbox$4 = hammerhead__default["default"].eventSandbox.message;
    var processScript = hammerhead__default["default"].processScript;
    var nativeMethods$4 = hammerhead__default["default"].nativeMethods;
    ...
    var NativeDialogTracker = /** @class */ (function () {
        ...
        NativeDialogTracker._getPageUrl = function () {
            return nativeMethods$4.eval(GETTING_PAGE_URL_PROCESSED_SCRIPT);
        };
        ...
        NativeDialogTracker.prototype._init = function () {
            var _this = this;
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.beforeUnload, function (e) {
        ...
        NativeDialogTracker.prototype._handleGeolocationDialog = function (successCallback, failCallback) {
            ...
            var url = NativeDialogTracker._getPageUrl();
            var isFirstGeolocationRequest = !nativeMethods$4.arraySome
        ...
        NativeDialogTracker.prototype._shouldOverrideGeolocationDialog = function (geolocation) {
            if (!(geolocation === null || geolocation === void 0 ? void 0 : geolocation.getCurrentPosition))
                return false;
            var isNativeMethod = nativeMethods$4.isNativeCode(geolocation.getCurrentPosition);
    ...
    var JSON$1 = hammerhead__default["default"].json;
    var nativeMethods$3 = hammerhead__default["default"].nativeMethods;
    ...
    var StorageStrategyProxy = /** @class */ (function (_super) {
        ...
        function StorageStrategyProxy(window, testRunId, windowId) {
            ...
            _this.storage = nativeMethods$3.winSessionStorageGetter.call(window);
        ...
        StorageStrategyProxy.prototype._getData = function () {
            return nativeMethods$3.storageGetItem.call(this.storage, this.storageKey);
        };
        StorageStrategyProxy.prototype._deleteData = function () {
            nativeMethods$3.storageRemoveItem.call(this.storage, this.storageKey);
        };
        StorageStrategyProxy.prototype.save = function (data) {
            nativeMethods$3.storageSetItem.call(this.storage, this.storageKey, JSON$1.stringify(data));
        };
    ...
    NODE_SNAPSHOT_PROPERTIES.concat(ELEMENT_SNAPSHOT_PROPERTIES);
    ...
    var nativeMethods$2 = hammerhead__default["default"].nativeMethods;
    function delay (ms) {
        return new Promise$3(function (resolve) { return nativeMethods$2.setTimeout.call(window, resolve, ms); });
    }
    ...
    createNativeMethodWrapper('filter');
    createNativeMethodWrapper('map');
    createNativeMethodWrapper('slice');
    createNativeMethodWrapper('splice');
    createNativeMethodWrapper('unshift');
    createNativeMethodWrapper('forEach');
    createNativeMethodWrapper('indexOf');
    createNativeMethodWrapper('some');
    createNativeMethodWrapper('reverse');
    createNativeMethodWrapper('reduce');
    createNativeMethodWrapper('concat');
    createNativeMethodWrapper('join');
    createNativeMethodWrapper('every');

    hammerhead__default["default"].utils.browser;
    hammerhead__default["default"].nativeMethods;
    // NOTE: We have to retrieve styleUtils.get from hammerhead
    // to avoid circular dependencies between domUtils and styleUtils
    hammerhead__default["default"].utils.style.get;
    hammerhead__default["default"].utils.dom.getActiveElement;
    hammerhead__default["default"].utils.dom.findDocument;
    hammerhead__default["default"].utils.dom.find;
    hammerhead__default["default"].utils.dom.isElementInDocument;
    var isElementInIframe = hammerhead__default["default"].utils.dom.isElementInIframe;
    var getIframeByElement = hammerhead__default["default"].utils.dom.getIframeByElement;
    hammerhead__default["default"].utils.dom.isCrossDomainWindows;
    hammerhead__default["default"].utils.dom.getSelectParent;
    hammerhead__default["default"].utils.dom.getChildVisibleIndex;
    hammerhead__default["default"].utils.dom.getSelectVisibleChildren;
    hammerhead__default["default"].utils.dom.isElementNode;
    hammerhead__default["default"].utils.dom.isTextNode;
    hammerhead__default["default"].utils.dom.isRenderedNode;
    hammerhead__default["default"].utils.dom.isIframeElement;
    hammerhead__default["default"].utils.dom.isInputElement;
    hammerhead__default["default"].utils.dom.isButtonElement;
    hammerhead__default["default"].utils.dom.isFileInput;
    hammerhead__default["default"].utils.dom.isTextAreaElement;
    hammerhead__default["default"].utils.dom.isAnchorElement;
    hammerhead__default["default"].utils.dom.isImgElement;
    hammerhead__default["default"].utils.dom.isFormElement;
    hammerhead__default["default"].utils.dom.isLabelElement;
    hammerhead__default["default"].utils.dom.isSelectElement;
    hammerhead__default["default"].utils.dom.isRadioButtonElement;
    hammerhead__default["default"].utils.dom.isColorInputElement;
    hammerhead__default["default"].utils.dom.isCheckboxElement;
    hammerhead__default["default"].utils.dom.isOptionElement;
    hammerhead__default["default"].utils.dom.isSVGElement;
    hammerhead__default["default"].utils.dom.isMapElement;
    hammerhead__default["default"].utils.dom.isBodyElement;
    var isHtmlElement = hammerhead__default["default"].utils.dom.isHtmlElement;
    hammerhead__default["default"].utils.dom.isDocument;
    hammerhead__default["default"].utils.dom.isTextEditableInput;
    hammerhead__default["default"].utils.dom.isTextEditableElement;
    hammerhead__default["default"].utils.dom.isTextEditableElementAndEditingAllowed;
    hammerhead__default["default"].utils.dom.isContentEditableElement;
    hammerhead__default["default"].utils.dom.isDomElement;
    hammerhead__default["default"].utils.dom.isShadowUIElement;
    hammerhead__default["default"].utils.dom.isShadowRoot;
    hammerhead__default["default"].utils.dom.isElementFocusable;
    hammerhead__default["default"].utils.dom.isHammerheadAttr;
    hammerhead__default["default"].utils.dom.isElementReadOnly;
    var getScrollbarSize = hammerhead__default["default"].utils.dom.getScrollbarSize;
    hammerhead__default["default"].utils.dom.getMapContainer;
    hammerhead__default["default"].utils.dom.getTagName;
    hammerhead__default["default"].utils.dom.closest;
    hammerhead__default["default"].utils.dom.getParents;
    hammerhead__default["default"].utils.dom.findParent;
    hammerhead__default["default"].utils.dom.getTopSameDomainWindow;
    hammerhead__default["default"].utils.dom.getParentExceptShadowRoot;

    hammerhead__default["default"].utils.style;
    var getBordersWidth = hammerhead__default["default"].utils.style.getBordersWidth;
    hammerhead__default["default"].utils.style.getComputedStyle;
    hammerhead__default["default"].utils.style.getElementMargin;
    hammerhead__default["default"].utils.style.getElementPadding;
    var getElementScroll = hammerhead__default["default"].utils.style.getElementScroll;
    hammerhead__default["default"].utils.style.getOptionHeight;
    hammerhead__default["default"].utils.style.getSelectElementSize;
    hammerhead__default["default"].utils.style.isElementVisible;
    hammerhead__default["default"].utils.style.isVisibleChild;
    hammerhead__default["default"].utils.style.getWidth;
    hammerhead__default["default"].utils.style.getHeight;
    var getInnerWidth = hammerhead__default["default"].utils.style.getInnerWidth;
    var getInnerHeight = hammerhead__default["default"].utils.style.getInnerHeight;
    hammerhead__default["default"].utils.style.getScrollLeft;
    hammerhead__default["default"].utils.style.getScrollTop;
    hammerhead__default["default"].utils.style.setScrollLeft;
    hammerhead__default["default"].utils.style.setScrollTop;
    hammerhead__default["default"].utils.style.get;
    hammerhead__default["default"].utils.style.getBordersWidthFloat;
    hammerhead__default["default"].utils.style.getElementPaddingFloat;

    hammerhead__default["default"].shadowUI;
    hammerhead__default["default"].nativeMethods;
    ...
    hammerhead__default["default"].utils.html;
    hammerhead__default["default"].nativeMethods;

    var getElementRectangle = hammerhead__default["default"].utils.position.getElementRectangle;
    var getOffsetPosition = hammerhead__default["default"].utils.position.getOffsetPosition;
    var offsetToClientCoords = hammerhead__default["default"].utils.position.offsetToClientCoords;
    ...
    var ActionExecutor = /** @class */ (function (_super) {
        ...
        ActionExecutor.prototype._ensureCommandElements = function () {
            var _this = this;
            var _a;
            var elsRetriever = new ElementsRetriever$1(this._options.globalSelectorTimeout, this._options.executeSelectorFn);
    ...
    var Promise$2 = hammerhead__default["default"].Promise;
    ...
    var settings = hammerhead__default["default"].settings;
    var transport = hammerhead__default["default"].transport;
    var Promise$1 = hammerhead__default["default"].Promise;
    var messageSandbox$2 = hammerhead__default["default"].eventSandbox.message;
    var storages = hammerhead__default["default"].storages;
    var nativeMethods$1 = hammerhead__default["default"].nativeMethods;
    var DateCtor = nativeMethods$1.date;
    var listeners = hammerhead__default["default"].eventSandbox.listeners;
    var urlUtils = hammerhead__default["default"].utils.url;
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        function Driver(testRunId, communicationUrls, runInfo, options) {
            ...
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.uncaughtJsError, function (err) { return _this._onJsError(err); });
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.unhandledRejection, function (err) { return _this._onJsError(err); });
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.consoleMethCalled, function (e) { return _this._onConsoleMessage(e); });
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.beforeFormSubmit, function (e) { return _this._onFormSubmit(e); });
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.beforeWindowOpened, function (e) { return _this._onBeforeChildWindowOpened(e); });
            hammerhead__default["default"].on(hammerhead__default["default"].EVENTS.windowOpened, function (e) { return _this._onChildWindowOpened(e); });
        ...
        Driver.prototype._getCurrentWindowId = function () {
            ...
            var parsedProxyUrl = hammerhead__default["default"].utils.url.parseProxyUrl(currentUrl);
        ...
        Driver.prototype._ensureClosedChildWindowWatcher = function () {
            ...
            if (this.checkClosedChildWindowIntervalId)
                return;
            this.checkClosedChildWindowIntervalId = nativeMethods$1.setInterval.call(window, function () {
                ...
                if (!_this.childWindowDriverLinks.length) {
                    nativeMethods$1.clearInterval.call(window, _this.checkClosedChildWindowIntervalId);
        ...
        Driver.prototype._setCurrentWindowAsMaster = function () {
            ...
            Promise$1.resolve()
                .then(function () {
                return testcafeCore.browser.setActiveWindowId(_this.communicationUrls.activeWindowId, hammerhead__default["default"].createNativeXHR, _this.windowId);
            })
                .then(function () {
        ...
        Driver.prototype._ensureNewWindowOpenedInNativeAutomation = function (e) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, testcafeCore.browser.ensureWindowInNativeAutomation(this.communicationUrls.ensureWindowInNativeAutomationUrl, hammerhead__default["default"].createNativeXHR)];
                        case 1:
                            result = _a.sent();
                            if (!result.windowId)
                                return [2 /*return*/, null];
                            if (e.form)
                                nativeMethods$1.formSubmit.apply(e.form);
                            else
                                nativeMethods$1.windowOpen.call(window, e.pageUrl, e.windowName);
        ...
        Driver.prototype._getWindowInfo = function () {
            ...
            if (!this.options.nativeAutomation) {
                var destUrl = hammerhead__default["default"].utils.url.parseProxyUrl(url).destUrl;
                url = destUrl;
            }
            return {
                id: this.windowId,
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            this.closing = true;
                            return [4 /*yield*/, testcafeCore.browser.closeWindow(this.communicationUrls.closeWindow, hammerhead__default["default"].createNativeXHR, this.windowId)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2:
        ...
        Driver.prototype._switchToIframe = function (selector, iframeErrorCtors) {
            ...
            return getResult(selector, commandSelectorTimeout, null, function (fn) { return new iframeErrorCtors.NotFoundError(null, fn); }, function () { return new iframeErrorCtors.IsInvisibleError(); }, this.statusBar)
                ...
                return _this._ensureChildIframeDriverLink(nativeMethods$1.contentWindowGetter.call(iframe), iframeErrorCtors.NotLoadedError, childLinkResponseTimeout);
            })
        ...
        Driver.prototype._waitForSkipJsErrorFunctionCompletion = function (driverStatus) {
            ...
            if (!this.contextStorage.getItem(EXECUTING_SKIP_JS_ERRORS_FUNCTION_FLAG))
                return Promise$1.resolve(driverStatus);
        ...
        Driver.prototype._createDispatchNativeAutomationEventFn = function (name) {
            return nativeMethods$1.functionBind.call(testcafeCore.browser[name], testcafeCore.browser[name], this.communicationUrls[name], hammerhead__default["default"].createNativeXHR);
        };
        // Commands handling
        ...
        Driver.prototype._onNavigateToCommand = function (command) {
            ...
            if (this.options.nativeAutomation && isFileProtocol(command.url)) {
                var redirectOpts = {
                    createXHR: hammerhead__default["default"].createNativeXHR,
        ...
        Driver.prototype._restoreChildWindowLinks = function () {
            return __awaiter(this, void 0, void 0, function () {
                var pendingChildWindowCount, restoreChildWindowsPromise;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
        ...
        Driver.prototype._onShowAssertionRetriesStatusCommand = function (command) {
            ...
            this.contextStorage.setItem(ASSERTION_RETRIES_START_TIME, nativeMethods$1.dateNow());
        ...
        Driver.prototype._checkStatus = function () {
            ...
            return testcafeCore.browser
                .checkStatus(urls, hammerhead__default["default"].createNativeXHR, { manualRedirect: true, nativeAutomation: this.options.nativeAutomation })
                .then(function (_a) {
        ...
        Driver.prototype._closeAllChildWindows = function () {
            ...
            return Promise$1.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
                ...
                .then(function () {
                nativeMethods$1.arrayForEach.call(_this.childWindowDriverLinks, function (childWindowDriverLink) {
        ...
        Driver.prototype._startInternal = function (opts) {
            ...
            testcafeCore.browser.startHeartbeat(this.communicationUrls.heartbeat, hammerhead__default["default"].createNativeXHR);
        ...
        Driver.prototype._setupAssertionRetryIndication = function () {
            ...
            this.readyPromise.then(function () {
                ...
                if (assertionRetriesTimeout) {
                    ...
                    var timeLeft = assertionRetriesTimeout - (new DateCtor() - startTime);
                    if (timeLeft > 0)
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, testcafeCore.browser.getActiveWindowId(this.communicationUrls.activeWindowId, hammerhead__default["default"].createNativeXHR)];
                        case 1:
        ...
        Driver.prototype._init = function () {
            ...
            this.statusBar = new testCafeUI__default["default"].StatusBar(this.runInfo.userAgent, this.runInfo.fixtureName, this.runInfo.testName, this.contextStorage, nativeAutomation);
            this.selectorInspectorPanel = new testCafeUI__default["default"].SelectorInspectorPanel(this.statusBar);
            var self = this;
    ...
    var messageSandbox$1 = hammerhead__default["default"].eventSandbox.message;
    ...
    var nativeMethods = hammerhead__default["default"].nativeMethods;
    var evalIframeScript = hammerhead__default["default"].EVENTS.evalIframeScript;
    ...
    hammerhead__default["default"].on(evalIframeScript, function (e) { return initTestCafeClientDrivers(nativeMethods.contentWindowGetter.call(e.iframe), true); });
