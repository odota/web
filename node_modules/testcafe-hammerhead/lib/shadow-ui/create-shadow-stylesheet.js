...
const css_tools_1 = __importDefault(require("@adobe/css-tools"));
...
function createShadowStylesheet(cssCode) {
    const ast = css_tools_1.default.parse(cssCode, { silent: true });
    if (ast.stylesheet)
        addUIClassPostfix(ast.stylesheet.rules);
    return css_tools_1.default.stringify(ast, { compress: false });
}
