...
const transformer = {
    ...
    nodeTypes: esotope_hammerhead_1.Syntax.ImportExpression,
    condition: () => true,
    run: node => {
        var _a;
        const newSource = node_builder_1.createGetProxyUrlMethodCall(node.source, (_a = transformer.getBaseUrl) === null || _a === void 0 ? void 0 : _a.call(transformer));
        replace_node_1.default(node.source, newSource, node, 'source');
        return null;
    },
};
