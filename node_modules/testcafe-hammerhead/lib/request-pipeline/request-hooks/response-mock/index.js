...
const validate_parameters_1 = __importDefault(require("./validate-parameters"));
...
class ResponseMock {
    constructor(body, statusCode, headers) {
        (0, validate_parameters_1.default)(body, statusCode, headers);
        this.id = (0, generate_unique_id_1.default)();
        this.body = body;
        this.isPredicate = (0, is_predicate_1.default)(body);
        this.error = null;
        this.hasError = false;
        if (headers)
            this.headers = (0, lowercase_header_names_1.default)(headers);
        if (statusCode)
