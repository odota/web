import{$ as je,a0 as be,a1 as ye,a2 as xe,a3 as qe,F as _,a4 as c,R as e,y as r,P as m,a5 as ee,B as H,a6 as ae,a7 as Ue,a8 as me,H as ve,z as y,a9 as Ke,aa as Ye,ab as O,T as P,ac as D,r as te,ad as Je,ae as Qe,af as Xe,ag as Ze,ah as ea,ai as se,aj as aa,ak as Ee,al as ta,am as sa,an as ra,ao as na,ap as ia,V as oa,aq as la,ar as ca,as as da,at as ha,A as Se,au as Ce,S as C,av as _a,aw as pa,C as Te,N as J,ax as K,ay as ma,X as ua}from"./index-c72629b3.js";var ga=je({chartName:"AreaChart",GraphicalChild:be,axisComponents:[{axisType:"xAxis",AxisComp:ye},{axisType:"yAxis",AxisComp:xe}],formatAxisMap:qe}),V="NOT_FOUND";function ka(a){var t;return{get:function(n){return t&&a(t.key,n)?t.value:V},put:function(n,i){t={key:n,value:i}},getEntries:function(){return t?[t]:[]},clear:function(){t=void 0}}}function fa(a,t){var s=[];function n(d){var l=s.findIndex(function(g){return t(d,g.key)});if(l>-1){var u=s[l];return l>0&&(s.splice(l,1),s.unshift(u)),u.value}return V}function i(d,l){n(d)===V&&(s.unshift({key:d,value:l}),s.length>a&&s.pop())}function o(){return s}function h(){s=[]}return{get:n,put:i,getEntries:o,clear:h}}var wa=function(t,s){return t===s};function ba(a){return function(s,n){if(s===null||n===null||s.length!==n.length)return!1;for(var i=s.length,o=0;o<i;o++)if(!a(s[o],n[o]))return!1;return!0}}function ya(a,t){var s=typeof t=="object"?t:{equalityCheck:t},n=s.equalityCheck,i=n===void 0?wa:n,o=s.maxSize,h=o===void 0?1:o,d=s.resultEqualityCheck,l=ba(i),u=h===1?ka(l):fa(h,l);function g(){var k=u.get(arguments);if(k===V){if(k=a.apply(null,arguments),d){var x=u.getEntries(),E=x.find(function(T){return d(T.value,k)});E&&(k=E.value)}u.put(arguments,k)}return k}return g.clearCache=function(){return u.clear()},g}function xa(a){var t=Array.isArray(a[0])?a[0]:a;if(!t.every(function(n){return typeof n=="function"})){var s=t.map(function(n){return typeof n=="function"?"function "+(n.name||"unnamed")+"()":typeof n}).join(", ");throw new Error("createSelector expects all input-selectors to be functions, but received the following types: ["+s+"]")}return t}function va(a){for(var t=arguments.length,s=new Array(t>1?t-1:0),n=1;n<t;n++)s[n-1]=arguments[n];var i=function(){for(var h=arguments.length,d=new Array(h),l=0;l<h;l++)d[l]=arguments[l];var u=0,g,k={memoizeOptions:void 0},x=d.pop();if(typeof x=="object"&&(k=x,x=d.pop()),typeof x!="function")throw new Error("createSelector expects an output function after the inputs, but received: ["+typeof x+"]");var E=k,T=E.memoizeOptions,R=T===void 0?s:T,W=Array.isArray(R)?R:[R],M=xa(d),B=a.apply(void 0,[function(){return u++,x.apply(null,arguments)}].concat(W)),p=a(function(){for(var F=[],L=M.length,A=0;A<L;A++)F.push(M[A].apply(null,arguments));return g=B.apply(null,F),g});return Object.assign(p,{resultFunc:x,memoizedResultFunc:B,dependencies:M,lastResult:function(){return g},recomputations:function(){return u},resetRecomputations:function(){return u=0}}),p};return i}var Ea=va(ya);const Sa=(a,t)=>a.find(s=>String(s.id)===String(t)),Ae=Ea(a=>a.app.proPlayers.data,a=>a.reduce((t,s)=>({...t,[s.account_id]:{...s}}),{})),Ca=_.div`
  background-color: ${c.colorDanger};
  padding: 15px;
  color: white;
`,re=a=>e.createElement(Ca,null,"Whoops! Something went wrong. ",a.text?a.text:"");re.propTypes={text:r.string};const Ta=_.div`
  flex: 1 1 0;
  padding: 0 16px;
  display: flex;
  align-items: center;
...
`,z=({style:a,attribute:t,isPrimary:s,base:n,gain:i})=>{const o={background:c.primaryTextColor},h={color:c.primaryTextColor};switch(t){default:o.background=c.colorAttributeStr,s&&(h.color=c.colorAttributeStr);break;case"agi":o.background=c.colorAttributeAgi,s&&(h.color=c.colorAttributeAgi);break;case"int":o.background=c.colorAttributeInt,s&&(h.color=c.colorAttributeInt);break}return e.createElement(Ta,{style:a},e.createElement(Aa,{attribute:t,style:o}),e.createElement(Pa,{attribute:t,style:h},n," + ",i))};z.propTypes={style:r.shape({}),attribute:r.string,isPrimary:r.bool,base:r.number,gain:r.number};const Ra=_.div`
...
`,Pe=({hero:a})=>e.createElement(Ra,null,e.createElement(Ia,null,e.createElement(z,{attribute:"str",isPrimary:a.primary_attr==="str",base:a.base_str,gain:a.str_gain}),e.createElement(z,{attribute:"agi",isPrimary:a.primary_attr==="agi",base:a.base_agi,gain:a.agi_gain}),e.createElement(z,{attribute:"int",isPrimary:a.primary_attr==="int",base:a.base_int,gain:a.int_gain})));Pe.propTypes={hero:r.shape({primary_attr:r.string,base_str:r.number,base_agi:r.number,base_int:r.number,str_gain:r.number,agi_gain:r.number,int_gain:r.number})};const Da=_.div`
...
`,Ba=_.div`
  ...
  position: absolute;
  right: 0;
`,Re=a=>{const t=ee(),s=a.mc&&parseInt(a.mc,0)>0;let n=!1;return s&&(n=typeof a.mc=="object"?a.mc[0]:a.mc),e.createElement(Da,{"data-tip":!0,"data-for":t},e.createElement(Ma,{src:H.VITE_IMAGE_CDN+a.img}),s&&e.createElement(Ba,null,n),e.createElement(ae,{id:t,effect:"solid",place:"bottom"},e.createElement(Ue,{ability:a})))};Re.propTypes={mc:m.oneOfType([m.object,m.array,m.string]),img:m.string.isRequired};const Fa=_.div`
  display: flex;
...
`,La=_.div`
  ...
  opacity: 0.08;
`,Ie=({talents:a,ttId:t})=>e.createElement(Ha,null,e.createElement(ae,{id:t,effect:"solid",place:"left"},e.createElement(Wa,null,e.createElement(La,null),e.createElement($,{talents:a[3],level:"25"}),e.createElement($,{talents:a[2],level:"20"}),e.createElement($,{talents:a[1],level:"15"}),e.createElement($,{talents:a[0],level:"10"}))));Ie.propTypes={talents:m.oneOfType([m.object,m.array]).isRequired,ttId:m.string.isRequired};const Na=_.div`
  background: linear-gradient(to bottom, ${c.colorBlueMuted}, ${c.primarySurfaceColor});
  border-radius: 4px;
  box-shadow: 0 2px 2px rgba(0, 0, 0, .3);
  position: relative;
...
While Pierce the Veil is active Muerta permanently gains 2% spell amplification each time she kills an enemy Hero or they die in her vicinity. Bonus applies retroactively.`,shard_skill_name:"Pierce the Veil",shard_new_skill:!1},{hero_name:"npc_dota_hero_kez",hero_id:145,has_scepter:!0,scepter_desc:`Casting any weapon ability refreshes the cooldown of Switch Discipline.

The first ability Kez casts 3 seconds after using Switch Discipline will not set its alternate weapon ability on cooldown.`,scepter_skill_name:"Switch Discipline",scepter_new_skill:!1,has_shard:!0,shard_desc:"Passively grants 10 movement speed, and an additional 10 movement speed per Marked enemy.",shard_skill_name:"Shodo Sai",shard_new_skill:!1}],za=_.div`
...
`,Va=_.div`
  ...
  font-weight: bold;
  letter-spacing: 1px;
`,Q=({image:a,type:t,children:s})=>e.createElement(za,null,e.createElement("div",{className:"header-content"},e.createElement("img",{id:`${t}-img`,src:a,alt:""}),e.createElement(Va,null,s)));Q.propTypes={image:m.string,type:m.string,children:m.oneOfType([m.arrayOf(m.node),m.node])};const ja=_.div`
  margin-left: 8px;
...
`,Xa=_.div`
  ...
  width: 40%;
  margin: 4px 0px;
`,Za=a=>{const s=(a.attrib||[]).map(n=>e.createElement("div",{className:"attribute",key:n.key},e.createElement("span",{id:"header"},n.header," "),e.createElement("span",{id:"value"},me(n.value)),e.createElement("span",{id:"footer"}," ",n.footer||"")));return e.createElement(e.Fragment,null,s,a.dmg?e.createElement("div",{className:"attribute"},"DAMAGE: ",e.createElement("span",{id:"value"},me(a.dmg))):"")},X=({icon:a,skillName:t,isNewSkill:s,aghsDescription:n,skillObject:i,hasUpgrade:o})=>e.createElement(Ja,null,o?e.createElement(e.Fragment,null,e.createElement(Ua,{src:a}),e.createElement(ja,null,e.createElement(Ka,null,t),e.createElement(Xa,null,s?e.createElement("span",null,"New ability"):e.createElement("span",null,"Upgrade")),e.createElement(qa,null,n,i.attrib&&i.attrib.length>0&&e.createElement("div",null,e.createElement(Qa,null),e.createElement(Ya,null,Za(i)))))):e.createElement("span",null,"No Aghanim's upgrade found"));X.propTypes={icon:m.string,skillName:m.string,isNewSkill:m.bool,aghsDescription:m.string,skillObject:m.shape({}),hasUpgrade:m.bool};const ge=_.div`
  width: 340px;
...
`,et=_.div`
  ...
  gap: 10px;
  margin: 0 -20px;
`,at=({upgrades:a,skills:t})=>{let s=null,n=null;const i=o=>!o||o===""?null:t.find(d=>d.data.dname===o).data;if(t&&a){const o=a.shard_skill_name,h=i(o);n=e.createElement(ge,null,e.createElement(Q,{image:"/assets/images/dota2/shard_0.png",type:"shard"},e.createElement("span",null,"Aghanim‘s Shard")),e.createElement(X,{icon:`${H.VITE_IMAGE_CDN}${h?h.img:""}`,skillName:a.shard_skill_name,hasUpgrade:a.has_shard,isNewSkill:a.shard_new_skill,aghsDescription:a.shard_desc,skillObject:h}));const d=a.scepter_skill_name,l=i(d);s=e.createElement(ge,null,e.createElement(Q,{image:"/assets/images/dota2/scepter_0.png",type:"scepter"},e.createElement("span",null,"Aghanim‘s Scepter")),e.createElement(X,{icon:`${H.VITE_IMAGE_CDN}${l?l.img:""}`,skillName:a.scepter_skill_name,hasUpgrade:a.has_scepter,isNewSkill:a.scepter_new_skill,aghsDescription:a.scepter_desc,skillObject:l}))}return e.createElement(et,null,s,n)},tt=_.div`
  background: linear-gradient(to bottom, ${c.colorBlueMuted}, ${c.primarySurfaceColor});
  border-radius: 4px;
  box-shadow: 0 2px 2px rgba(0, 0, 0, .3);
  position: relative;
...
`,Me=({upgrades:a,skills:t})=>e.createElement(tt,null,e.createElement(st,null,e.createElement(ae,{id:"aghanim",effect:"solid",place:"bottom"},e.createElement(at,{type:"scepter",upgrades:a,skills:t}))));Me.propTypes={upgrades:m.shape({}).isRequired,skills:m.array.isRequired};const rt=_.div`
  background: linear-gradient(to bottom, ${c.colorBlueMuted}, ${c.primarySurfaceColor});
  border-radius: 4px;
  box-shadow: 0 2px 2px rgba(0, 0, 0, .3);
  position: relative;
...
`,it=a=>Oa.filter(s=>s.hero_name===a)[0]||{},Be=({heroName:a,skills:t})=>e.createElement(rt,null,e.createElement(Me,{heroName:a,upgrades:it(a),skills:t}),e.createElement(nt,{"data-for":"aghanim","data-tip":"aghanim"},e.createElement(ke,{src:"/assets/images/dota2/scepter_0.png",alt:"Aghanim's scepter"}),e.createElement(ke,{src:"/assets/images/dota2/shard_0.png",alt:"Aghanim's shard"})));Be.propTypes={heroName:m.string,skills:m.shape({})};const Y=(await ve(()=>import("./abilities-3865af33.js"),[])).default,ot=(await ve(()=>import("./index-c72629b3.js").then(a=>a.aA),[])).default,lt=_.div`
  align-items: center;
  display: flex;
  justify-content: center;
  margin-left: -4px;
...
`,Z=_.div`
  ...
  padding-left: 4px;
  padding-right: 4px;
`,ct=a=>a.map(t=>e.createElement(Z,{key:t.key},e.createElement(Re,{...t.data,abilityID:t.key}))),Fe=({hero:a})=>{const t=d=>d.filter(l=>l!=="generic_hidden"&&Y[l].behavior!=="Hidden"),s=d=>d.map((l,u)=>({data:Y[l],key:u})),n=d=>d.map(l=>({...Y[l.name],...l})),i=d=>{const l=[];return d.forEach((u,g)=>{l[Math.floor(g/2)]||(l[Math.floor(g/2)]=[]),l[Math.floor(g/2)].push({name:u.dname})}),l},h=(d=>{const l={skills:[],talents:[]},u=d.name,g=ot[u];g.abilities=t(g.abilities),l.skills=s(g.abilities);const k=n(g.talents);return l.talents=i(k),l})(a);return e.createElement(lt,null,e.createElement(Z,null,e.createElement(De,{talents:h.talents})),ct(h.skills),e.createElement(Z,null,e.createElement(Be,{heroName:a.name,skills:h.skills})))};Fe.propTypes={hero:m.shape({}).isRequired};const dt=a=>({}),ht=y(dt)(Fe),fe=a=>H.VITE_IMAGE_CDN+a,_t=_.div`
...
`,yt=_.div`
  flex: 1 1 100%;
`,$e=({hero:a})=>e.createElement(bt,null,e.createElement(_t,null,e.createElement(pt,{alt:a.localized_name,src:fe(a.img)}),e.createElement(mt,null,e.createElement(gt,{alt:a.localized_name,src:fe(a.img)}),e.createElement(ut,null,e.createElement(kt,null,a.localized_name),e.createElement(ft,null,a.attack_type," - ",e.createElement(wt,null,a.roles.join(", ")))),e.createElement(yt,null,e.createElement(Pe,{hero:a}),e.createElement(ht,{hero:a})))));$e.propTypes={hero:r.shape({})};const He=({rankings:a,strings:t})=>{const s=[{displayName:t.th_rank,displayFn:(n,i,o,h)=>Ke(h+1)},{displayName:t.th_name,displayFn:(n,i,o)=>{const h=Ye(n.rank_tier);return O.player({...n,subtitle:h},i,o)}},{displayName:t.th_score,field:"score",displayFn:n=>parseFloat(n.score).toFixed(),relativeBars:!0}];return e.createElement(P,{data:a,columns:s})};He.propTypes={rankings:r.oneOfType([r.arrayOf(r.shape({})),r.shape({})]),strings:r.shape({})};const xt=a=>({strings:a.app.strings}),vt=y(xt)(He),Et=a=>e.createElement(D,{primaryColor:"#666",secondaryColor:"#ecebeb",width:400,animate:!0,...a},e.createElement("rect",{x:"0",y:"10",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"25",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"40",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"55",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"70",rx:"5",ry:"5",width:"300",height:"5"})),St=(a,t)=>e.createElement("div",null,e.createElement(vt,{rankings:t}));class Ct extends te.Component{static propTypes={match:r.shape({params:r.shape({heroId:r.string})}),isLoading:r.bool,isError:r.bool,rankings:r.oneOfType([r.arrayOf(r.shape({})),r.shape({})]),hero:r.string,getRanking:r.func};componentDidMount(){this.props.match.params&&this.props.match.params.heroId&&this.props.getRanking(this.props.match.params.heroId)}render(){const{isLoading:t,isError:s,rankings:n,hero:i}=this.props;return e.createElement("div",null,t||s||n===null?e.createElement(Et,null):St(i,n||[]))}}const Tt=a=>({rankings:a.app.heroRanking.data.rankings,isLoading:a.app.heroRanking.loading,isError:a.app.heroRanking.error}),At=a=>({getRanking:t=>a(Je(t))}),Pt=y(Tt,At)(Ct),We=({data:a,strings:t})=>{const s=n=>Object.keys(n[0]||{}).map(i=>({displayName:t[`th_${i}`],tooltip:t[`tooltip_${i}`],field:i,displayFn:(o,h,d)=>i==="percentile"?`${d*100}%`:typeof d=="number"&&Number(d.toFixed(2))}));return e.createElement(P,{data:a,columns:s(a)})};We.propTypes={data:r.oneOfType([r.arrayOf(r.shape({})),r.shape({})]),strings:r.shape({})};const Rt=a=>({strings:a.app.strings}),It=y(Rt)(We),Dt=_.div`
...
`,Mt=_.div`
  ...
  text-transform: uppercase;
`,Bt={stroke:c.colorBlueGray,strokeWidth:2},Ft={background:c.almostBlack,border:0},$t={background:"transparent",border:0},Le=({data:a})=>{const t=ee();return e.createElement(Dt,null,e.createElement(Qe,{width:"100%",height:250},e.createElement(ga,{data:a.data,margin:{top:0,right:0,left:0,bottom:0}},e.createElement("defs",null,e.createElement("linearGradient",{id:`colorGraph-${t}`,x1:"0",y1:"0",x2:"0",y2:"1"},e.createElement("stop",{offset:"50%",stopColor:a.color,stopOpacity:".95"}),e.createElement("stop",{offset:"100%",stopColor:a.color,stopOpacity:"0"}))),e.createElement(Xe,{stroke:"rgba(255, 255, 255, .1)",strokeDasharray:"0"}),e.createElement(ye,{dataKey:"Percentage"}),e.createElement(xe,null),e.createElement(be,{dataKey:"Value",name:a.title,stroke:a.color,strokeWidth:"3",fill:`url(#colorGraph-${t})`}),e.createElement(Ze,{wrapperStyle:Ft,contentStyle:$t,cursor:Bt}))),e.createElement(Mt,null,a.title))};Le.propTypes={data:m.shape({}).isRequired};const Ht=_.div`
  display: flex;
  flex-wrap: wrap;
  margin: 48px -8px;
...
`,S=(a,t)=>a.map(s=>({Percentage:`${s.percentile*100}%`,Value:typeof s[t]=="number"&&Number(s[t].toFixed(2))})),Wt=(a,t)=>[{title:t.tooltip_gold_per_min,data:S(a,"gold_per_min"),color:c.golden},{title:t.tooltip_xp_per_min,data:S(a,"xp_per_min"),color:c.blue},{title:t.tooltip_hero_damage_per_min,data:S(a,"hero_damage_per_min"),color:c.red},{title:t.tooltip_hero_healing_per_min,data:S(a,"hero_healing_per_min"),color:c.green},{title:t.tooltip_kills_per_min,data:S(a,"kills_per_min"),color:c.yelor},{title:t.tooltip_last_hits_per_min,data:S(a,"last_hits_per_min"),color:c.colorBlueGray},{title:t.tooltip_lhten,data:S(a,"lhten"),color:c.golden},{title:t.tooltip_stuns_per_min,data:S(a,"stuns_per_min"),color:c.red}],Lt=a=>a.map(t=>e.createElement(Le,{key:t.title,data:t})),Ne=({data:a,strings:t})=>{const s=Wt(a,t);return e.createElement(Ht,null,Lt(s))};Ne.propTypes={data:m.arrayOf(m.shape({})),strings:m.shape({})};const Nt=a=>e.createElement(D,{primaryColor:"#666",secondaryColor:"#ecebeb",width:400,animate:!0,...a},e.createElement("rect",{x:"0",y:"10",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"25",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"40",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"55",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"70",rx:"5",ry:"5",width:"300",height:"5"})),Gt=(a,t,s)=>e.createElement("div",null,e.createElement(Ne,{data:t,strings:s}),e.createElement(It,{data:t}));class Ot extends te.Component{static propTypes={match:r.shape({params:r.shape({heroId:r.string})}),strings:r.shape({}),getBenchmark:r.func,isLoading:r.bool,isError:r.bool,hero:r.shape({}),result:r.oneOfType([r.arrayOf(r.shape({})),r.shape({})])};componentDidMount(){this.props.match.params&&this.props.match.params.heroId&&this.props.getBenchmark(this.props.match.params.heroId)}render(){const{isLoading:t,isError:s,hero:n,result:i}=this.props;return e.createElement("div",null,t||s||i===null?e.createElement(Nt,null):Gt(n,i,this.props.strings))}}const zt=a=>({isLoading:a.app.heroBenchmark.loading,isError:a.app.heroBenchmark.error,result:a.app.heroBenchmark.data.result}),Vt=a=>({getBenchmark:t=>a(ea(t))}),jt=y(zt,Vt)(Ot),qt=a=>e.createElement(D,{primaryColor:"#666",secondaryColor:"#ecebeb",width:400,animate:!0,...a},e.createElement("rect",{x:"0",y:"10",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"25",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"40",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"55",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"70",rx:"5",ry:"5",width:"300",height:"5"}));class Ge extends e.Component{static propTypes={isLoading:r.bool,isError:r.bool,result:r.oneOfType([r.arrayOf(r.shape({})),r.shape({})]),onGetRecentMatches:r.func,match:r.shape({params:r.shape({heroId:r.string})}),proPlayers:r.shape({name:r.string}),strings:r.shape({})};componentDidMount(){const{onGetRecentMatches:t,match:s}=this.props;s.params&&s.params.heroId&&t(s.params.heroId)}render(){const{isLoading:t,isError:s,result:n,proPlayers:i,strings:o}=this.props,h=[{displayName:o.th_account_id,field:"account_id",displayFn:(l,u,g)=>e.createElement("div",null,e.createElement(se,{to:`/players/${g}`},l.name?l.name:g))},{displayName:o.th_duration,tooltip:o.tooltip_duration,field:"duration",sortFn:!0,displayFn:O.duration},{displayName:o.th_result,tooltip:o.tooltip_result,field:"radiant_win",displayFn:O.radiant_win_and_game_mode},{displayName:o.th_kills,tooltip:o.tooltip_kills,field:"kills",sortFn:!0,displayFn:O.kda},{displayName:o.th_deaths,tooltip:o.tooltip_deaths,field:"deaths",sortFn:!0},{displayName:o.th_assists,tooltip:o.tooltip_assists,field:"assists",sortFn:!0}];if(s||n&&n.error)return e.createElement(re,null);const d=n.map(l=>{const u=i[l.account_id];return{name:u?u.name:void 0,...l}});return e.createElement("div",null,t||s||n===null?e.createElement(qt,null):e.createElement(P,{data:d,columns:h,paginated:!0}))}}Ge.defaultProps={result:null,isError:!1,isLoading:!1};const Ut=a=>({isLoading:a.app.heroRecentGames.loading,isError:a.app.heroRecentGames.error||!!a.app.heroRecentGames.data.error,result:a.app.heroRecentGames.data,proPlayers:Ae(a),strings:a.app.strings}),Kt={onGetRecentMatches:aa},Yt=y(Ut,Kt)(Ge),Jt=a=>e.createElement(D,{primaryColor:"#666",secondaryColor:"#ecebeb",width:400,animate:!0,...a},e.createElement("rect",{x:"0",y:"10",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"25",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"40",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"55",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"70",rx:"5",ry:"5",width:"300",height:"5"})),Qt=_.img`
  width: 50px;
  margin-right: 10px;
`,Xt=_.div`
  display: flex;
  align-items: center;
`,Zt=(a,t)=>{const s=new Map;return a.forEach(n=>s.set(n.id,n)),[{field:"hero_id",displayName:t.th_hero_id,displayFn:(n,i,o)=>{const h=s.get(o)||{};return e.createElement(Xt,null,e.createElement(Qt,{key:o,alt:h.localized_name,src:H.VITE_IMAGE_CDN+h.img}),e.createElement(se,{to:`/heroes/${o}`},h.localized_name))}},{field:"games_played",displayName:t.th_games_played,relativeBars:!0,sortFn:!0},{field:"win_rate",displayName:t.th_win,relativeBars:!0,sortFn:!0},{tooltip:t.tooltip_advantage,field:"advantage",displayName:t.th_advantage,relativeBars:!0,sortFn:!0,displayFn:(n,i,o)=>`${o}`}]};class es extends e.Component{static propTypes={isLoading:r.bool,match:r.shape({params:r.shape({heroId:r.string})}),data:r.arrayOf(r.shape({hero_id:r.number,games_played:r.number,wins:r.number})),heroes:r.arrayOf(r.shape({localized_name:r.string,img:r.string})),onGetHeroMatchups:r.func,strings:r.shape({})};componentDidMount(){const{onGetHeroMatchups:t,match:s}=this.props;s.params&&s.params.heroId&&t(s.params.heroId)}renderTable(){const{heroes:t,data:s,strings:n}=this.props,i=s.map(o=>({...o,win_rate:Math.max(0,Math.min(100,(o.wins/o.games_played*100).toFixed(2))),advantage:Math.round(Ee(o.wins,o.games_played-o.wins)*100)})).sort((o,h)=>h.games_played-o.games_played);return e.createElement(P,{data:i,columns:Zt(t,n)})}render(){const{isLoading:t}=this.props;return t?e.createElement(Jt,null):this.renderTable()}}const as=({app:a})=>({isLoading:a.heroMatchups.loading,data:a.heroMatchups.data,heroes:a.heroStats.data,strings:a.strings}),ts={onGetHeroMatchups:ta},ss=y(as,ts)(es),rs=_.span`
...
`,f=({style:a,primary:t,children:s})=>e.createElement(rs,{style:a,primary:t},s);f.propTypes={style:r.shape({}),primary:r.bool,children:r.node};const ns=_.div`
  display: flex;
  margin-left: -8px;
  margin-right: -8px;
...
`,w=_.span`
  ...
  margin-right: 5px;
  text-transform: uppercase;
`,is=a=>Math.round(.06*a/(1+.06*a)*100),Oe=({hero:a,strings:t})=>{const s=sa(a);return e.createElement(ns,null,e.createElement(N,null,e.createElement(f,null,e.createElement(w,null,t.heading_attack,":")," ",`${s.base_attack_min} - ${s.base_attack_max}`),e.createElement(f,null,e.createElement(w,null,t.heading_attack_range,":")," ",s.attack_range),e.createElement(f,null,e.createElement(w,null,t.heading_attack_speed,":")," ",s.attack_rate),s.projectile_speed!==0&&e.createElement(f,null,e.createElement(w,null,t.heading_projectile_speed,":")," ",s.projectile_speed)),e.createElement(N,null,e.createElement(f,null,e.createElement(w,null,t.heading_base_health,":")," ",s.base_health),e.createElement(f,null,e.createElement(w,null,t.heading_base_health_regen,":")," ",s.base_health_regen),e.createElement(f,null,e.createElement(w,null,t.heading_base_mana,":")," ",s.base_mana),e.createElement(f,null,e.createElement(w,null,t.heading_base_mana_regen,":")," ",s.base_mana_regen)),e.createElement(N,null,e.createElement(f,null,e.createElement(w,null,t.heading_base_armor,":")," ",`${s.base_armor} (${is(s.base_armor)}%)`),e.createElement(f,null,e.createElement(w,null,t.heading_base_mr,":")," ",`${s.base_mr}%`),e.createElement(f,null,e.createElement(w,null,t.heading_move_speed,":")," ",s.move_speed),e.createElement(f,null,e.createElement(w,null,t.heading_turn_rate,":")," ",s.turn_rate)),e.createElement(N,null,e.createElement(f,null,e.createElement(w,null,t.heading_legs,":")," ",s.legs),e.createElement(f,null,e.createElement(w,null,t.heading_cm_enabled,":")," ",s.cm_enabled?t.yes:t.no)))};Oe.propTypes={hero:r.shape({primary_attr:r.string,base_health:r.number,base_health_regen:r.number,base_mana:r.number,base_mana_regen:r.number,base_armor:r.number,base_mr:r.number,base_attack_min:r.number,base_attack_max:r.number,base_str:r.number,base_agi:r.number,base_int:r.number,str_gain:r.number,agi_gain:r.number,int_gain:r.number,attack_range:r.number,projectile_speed:r.number,attack_rate:r.number,move_speed:r.number,turn_rate:r.number,cm_enabled:r.bool,legs:r.number}),strings:r.shape({})};const os=a=>({strings:a.app.strings}),ls=y(os)(Oe),cs=a=>e.createElement(D,{height:200,width:500,primaryColor:"#666",secondaryColor:"#ecebeb",animate:!0,...a},e.createElement("rect",{x:"150",y:"50",rx:"5",ry:"5",width:"5",height:"100"}),e.createElement("rect",{x:"160",y:"45",rx:"5",ry:"5",width:"5",height:"105"}),e.createElement("rect",{x:"170",y:"41",rx:"5",ry:"5",width:"5",height:"109"}),e.createElement("rect",{x:"180",y:"37",rx:"5",ry:"5",width:"5",height:"113"}),e.createElement("rect",{x:"190",y:"33",rx:"5",ry:"5",width:"5",height:"117"}),e.createElement("rect",{x:"200",y:"29",rx:"5",ry:"5",width:"5",height:"121"}),e.createElement("rect",{x:"210",y:"25",rx:"5",ry:"5",width:"5",height:"125"}),e.createElement("rect",{x:"220",y:"21",rx:"5",ry:"5",width:"5",height:"129"}),e.createElement("rect",{x:"230",y:"18",rx:"5",ry:"5",width:"5",height:"132"}),e.createElement("rect",{x:"240",y:"15",rx:"5",ry:"5",width:"5",height:"135"}),e.createElement("rect",{x:"250",y:"14",rx:"5",ry:"5",width:"5",height:"136"}),e.createElement("rect",{x:"260",y:"14",rx:"5",ry:"5",width:"5",height:"136"}),e.createElement("rect",{x:"270",y:"15",rx:"5",ry:"5",width:"5",height:"135"}),e.createElement("rect",{x:"280",y:"18",rx:"5",ry:"5",width:"5",height:"132"}),e.createElement("rect",{x:"290",y:"21",rx:"5",ry:"5",width:"5",height:"129"}),e.createElement("rect",{x:"300",y:"25",rx:"5",ry:"5",width:"5",height:"125"}),e.createElement("rect",{x:"310",y:"29",rx:"5",ry:"5",width:"5",height:"121"}),e.createElement("rect",{x:"320",y:"33",rx:"5",ry:"5",width:"5",height:"117"}),e.createElement("rect",{x:"330",y:"37",rx:"5",ry:"5",width:"5",height:"113"}),e.createElement("rect",{x:"340",y:"41",rx:"5",ry:"5",width:"5",height:"109"}),e.createElement("rect",{x:"350",y:"45",rx:"5",ry:"5",width:"5",height:"105"}));class ds extends e.Component{static propTypes={match:r.shape({params:r.shape({heroId:r.string})}),onGetHeroDurations:r.func,isLoading:r.bool,data:r.arrayOf(r.shape({duration_bin:r.number,gamed_played:r.number,wins:r.number})),strings:r.shape({})};componentDidMount(){const{onGetHeroDurations:t,match:s}=this.props;s.params&&s.params.heroId&&t(s.params.heroId)}render(){const{isLoading:t,data:s,strings:n}=this.props;if(t)return e.createElement(cs,null);const i=s.map(o=>({win:o.wins,games:o.games_played,x:o.duration_bin/60})).sort((o,h)=>o.x-h.x);return e.createElement("div",null,e.createElement(ra,{columns:i,xAxisLabel:n.hero_duration_x_axis}))}}const hs={onGetHeroDurations:na},_s=({app:a})=>({isLoading:a.heroDurations.loading,data:Object.values(a.heroDurations.data),strings:a.strings}),ps=y(_s,hs)(ds),ms=a=>e.createElement(D,{primaryColor:"#666",secondaryColor:"#ecebeb",width:400,animate:!0,...a},e.createElement("rect",{x:"0",y:"10",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"25",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"40",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"55",rx:"5",ry:"5",width:"300",height:"5"}),e.createElement("rect",{x:"0",y:"70",rx:"5",ry:"5",width:"300",height:"5"}));class us extends e.Component{static propTypes={isLoading:r.bool,data:r.arrayOf(r.shape({account_id:r.number,games_played:r.number,wins:r.number})),match:r.shape({params:r.shape({heroId:r.string})}),onGetHeroPlayers:r.func,proPlayers:r.shape({}),strings:r.shape({})};componentDidMount(){const{onGetHeroPlayers:t,match:s}=this.props;s.params&&s.params.heroId&&t(s.params.heroId)}render(){const{data:t,isLoading:s,proPlayers:n,strings:i}=this.props,o=[{field:"account_id",displayName:i.th_account_id,displayFn:(d,l,u)=>e.createElement(se,{to:`/players/${u}`},d.name||u)},{field:"games_played",displayName:i.th_games_played,relativeBars:!0,sortFn:!0},{field:"wins",displayName:i.th_win,relativeBars:!0,sortFn:!0,displayFn:(d,l,u)=>`${u}`},{tooltip:i.tooltip_advantage,field:"advantage",displayName:i.th_advantage,relativeBars:!0,sortFn:!0,displayFn:(d,l,u)=>`${u}`}];if(s)return e.createElement(ms,null);const h=t.map(d=>{const l=Math.max(0,Math.min(100,(d.wins/d.games_played*100).toFixed(2))),u=Math.round(Ee(d.wins,d.games_played-d.wins)*100),g=n[d.account_id],k=g?g.name:void 0;return{...d,wins:l,advantage:u,name:k}}).sort((d,l)=>l.games_played-d.games_played);return e.createElement(P,{data:h,columns:o,paginated:!0})}}const gs=a=>({isLoading:a.app.heroPlayers.loading,data:Object.values(a.app.heroPlayers.data),proPlayers:Ae(a),strings:a.app.strings}),ks={onGetHeroPlayers:ia},fs=y(gs,ks)(us);function ze(a){const t=(h,d,l)=>Object.keys(l).map(u=>ca(da[u])),{onGetHeroItemSuggestions:s,match:n}=a;te.useEffect(()=>{n.params&&n.params.heroId&&s(n.params.heroId)},[s,n]);const i=[{field:"start_game_items",displayName:"Start Game",displayFn:t},{field:"early_game_items",displayName:"Early Game",displayFn:t},{field:"mid_game_items",displayName:"Mid Game",displayFn:t},{field:"late_game_items",displayName:"Late Game",displayFn:t}],o=a.data;return a.isLoading?e.createElement(oa,null):e.createElement(P,{data:o,columns:i})}ze.propTypes={match:m.shape({params:m.shape({heroId:m.string})}),isLoading:m.bool};const ws=({app:a})=>({isLoading:a.heroItemSuggestions.loading,data:Object.values(a.heroItemSuggestions.data)}),bs={onGetHeroItemSuggestions:la},ys=y(ws,bs)(ze),xs=_.div`
  margin-bottom: 8px;
`,vs=_.div`
  text-align: center;
`,Es=_(_a)`
...
`,Ss=_.div`
  width: 100%;
`;class ne extends e.Component{constructor(t){super(t),this.toggleDetailVisibility=this.toggleDetailVisibility.bind(this)}state={detailsOpen:!1};toggleDetailVisibility(t){t.preventDefault(),this.setState({detailsOpen:!this.state.detailsOpen})}render(){const{strings:t}=this.props,s=this.props.match.params.info||"rankings",{heroId:n}=this.props.match.params,i=Sa(this.props.heroes,n);if(this.props.heroes.length===0)return e.createElement(ha,null);if(!i){const d=`Hero ${n} not found...`;return e.createElement(re,{text:d})}const o=d=>[{name:t.tab_rankings,key:"rankings",content:l=>e.createElement("div",null,e.createElement(C,{title:t.tab_rankings,subtitle:t.rankings_description}),e.createElement(Pt,{...l})),route:`/heroes/${d}/rankings`},{name:t.tab_benchmarks,key:"benchmarks",content:l=>e.createElement("div",null,e.createElement(C,{title:t.tab_benchmarks,subtitle:t.hero_disclaimer_public}),e.createElement(jt,{...l})),route:`/heroes/${d}/benchmarks`},{name:t.tab_recent,key:"recent",content:l=>e.createElement("div",null,e.createElement(C,{title:t.tab_recent,subtitle:t.hero_disclaimer_pro}),e.createElement(Yt,{...l})),route:`/heroes/${d}/recent`},{name:t.tab_matchups,key:"matchups",content:l=>e.createElement("div",null,e.createElement(C,{title:t.tab_matchups,subtitle:t.hero_disclaimer_pro}),e.createElement(ss,{...l})),route:`/heroes/${d}/matchups`},{name:t.tab_durations,key:"durations",content:l=>e.createElement("div",null,e.createElement(C,{title:t.tab_durations,subtitle:t.hero_disclaimer_pro}),e.createElement(ps,{...l})),route:`/heroes/${d}/durations`},{name:t.tab_players,key:"players",content:l=>e.createElement("div",null,e.createElement(C,{title:t.tab_players,subtitle:t.hero_disclaimer_pro}),e.createElement(fs,{...l})),route:`/heroes/${d}/players`},{name:t.tab_items,key:"items",content:l=>e.createElement(e.Fragment,null,e.createElement(C,{title:"Suggested Items",subtitle:t.hero_disclaimer_pro}),e.createElement(ys,{...l})),route:`/heroes/${d}/items`}],h=o(n).find(d=>d.key===s);return e.createElement("div",null,e.createElement(Se,{title:i.localized_name}),e.createElement(xs,null,e.createElement($e,{hero:i}),e.createElement(vs,null,e.createElement(Es,{type:"button",onClick:this.toggleDetailVisibility},this.state.detailsOpen?t.hide_details:t.show_details)),this.state.detailsOpen&&e.createElement(ls,{hero:i})),e.createElement(Ss,null,e.createElement(Ce,{info:s,tabs:o(n)}),h?h.content(this.props):null))}}const{shape:G,string:we,arrayOf:Cs}=m;ne.propTypes={match:G({params:G({info:we,heroId:we})}),heroes:Cs(G({})),strings:G({})};ne.defaultProps={heroes:[]};const Ts=a=>({isLoading:a.app.heroStats.loading,isError:a.app.heroStats.error,heroes:a.app.heroStats.data,strings:a.app.strings}),As=y(Ts)(ne),Ps=a=>({pro:Is(a.strings),public:Ds(a.strings),turbo:Rs(a.strings)})[a.tabType],Rs=a=>[ie(a),{displayName:a.hero_turbo_pick_rate,field:"pickRateTurbo",sortFn:!0,displayFn:(n,i,o)=>(o*100).toFixed(1),percentBarsWithValue:n=>b(n.pickRateTurbo,n.matchCountTurbo)},{displayName:a.hero_turbo_win_rate,field:"winRateTurbo",sortFn:!0,displayFn:(n,i,o)=>(o*100).toFixed(1),percentBarsWithValue:n=>b(n.winRateTurbo,n.turbo_picks)}],Is=a=>[ie(a),{displayName:a.hero_pick_ban_rate,field:"pickBanRatePro",sortFn:!0,percentBarsWithValue:n=>b(n.pickBanRatePro,n.matchCountPro)},{displayName:a.hero_pick_rate,field:"pickRatePro",sortFn:!0,percentBarsWithValue:n=>b(n.pickRatePro,n.matchCountPro)},{displayName:a.hero_ban_rate,field:"banRatePro",sortFn:!0,percentBarsWithValue:n=>b(n.banRatePro,n.matchCountPro)},{displayName:a.hero_win_rate,field:"winRatePro",sortFn:!0,percentBarsWithValue:n=>b(n.winRatePro,n.pro_pick)}],ie=a=>({displayName:a.th_hero_id,tooltip:a.tooltip_hero_id,field:"hero_id",displayFn:pa,sortFn:t=>J[t.hero_id]?.localized_name}),b=(a,t)=>{if(a>0){const s=a*t;return Te(Math.floor(s))}return 0},Ds=a=>{const t=[{displayName:`${a.rank_tier_overall} ${a.abbr_pick}%`,field:"pickRatePub",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.pickRatePub,i.matchCountPub)},{displayName:`${a.rank_tier_overall} ${a.abbr_win}%`,field:"winRatePub",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.winRatePub,i.pickCountPub)},{displayName:`${a.rank_tier_high} ${a.abbr_pick}%`,displayIcon:I(8),field:"pickRateHigh",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.pickRateHigh,i.matchCountHigh),colColor:c.colorImmortal},{displayName:`${a.rank_tier_high} ${a.abbr_win}%`,displayIcon:I(8),field:"winRateHigh",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.winRateHigh,i.pickCountHigh),colColor:c.colorImmortalAlt},{displayName:`${a.rank_tier_mid} ${a.abbr_pick}%`,displayIcon:I(5),field:"pickRateMid",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.pickRateMid,i.matchCountMid),colColor:c.colorLegend},{displayName:`${a.rank_tier_mid} ${a.abbr_win}%`,displayIcon:I(5),field:"winRateMid",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.winRateMid,i.pickCountMid),colColor:c.colorLegendAlt},{displayName:`${a.rank_tier_low} ${a.abbr_pick}%`,displayIcon:I(3),field:"pickRateLow",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.pickRateLow,i.matchCountLow),colColor:c.colorCrusader},{displayName:`${a.rank_tier_low} ${a.abbr_win}%`,displayIcon:I(3),field:"winRateLow",sortFn:!0,displayFn:(i,o,h)=>(h*100).toFixed(1),percentBarsWithValue:i=>b(i.winRateLow,i.pickCountLow),colColor:c.colorCrusaderAlt}],s=Ms(a),n=Ve(t);return s.concat(n)},I=a=>`/assets/images/dota2/rank_icons/rank_icon_${a}.png`,Ve=(a,t)=>a.map(s=>({...s,tooltip:s.displayName,paddingRight:1,paddingLeft:4})),Ms=a=>{const t=[ie(a)];return Ve(t)};class Bs extends e.Component{static propTypes={dispatchHeroStats:m.func,onGetProPlayers:m.func,data:m.oneOfType([m.shape({}),m.arrayOf(m.shape({}))]),loading:m.bool,match:m.shape({params:m.shape({info:m.string,heroId:m.string})}),strings:m.shape({})};componentDidMount(){this.props.dispatchHeroStats(),this.props.onGetProPlayers()}getMatchCountByRank=(t,s)=>t.map(n=>n[s]||0).reduce(K,0)/10;createTab=(t,s)=>{const{strings:n}=this.props,i={public:n.hero_public_tab,turbo:n.hero_turbo_tab},o={public:n.hero_public_heading,turbo:n.hero_turbo_heading},h=i[t]??n.hero_pro_tab,d=o[t]??n.hero_pro_heading;return{name:h,key:t,content:(l,u,g)=>e.createElement("div",null,e.createElement(C,{className:"top-heading with-tabbar",title:d,subtitle:`${Te(s)} ${n.hero_last_7days}`,icon:"",twoLine:!0}),e.createElement(P,{data:l,columns:u,loading:g})),route:`/heroes/${t}`}};render(){const t=this.props.match.params.heroId||"pro";if(Number.isInteger(Number(t)))return e.createElement(As,{...this.props});const s=this.props.data,n=s.map(p=>p.pro_pick||0).reduce(K,0)/10,i=this.getMatchCountByRank(s,"8_pick"),o=this.getMatchCountByRank(s,"7_pick"),h=this.getMatchCountByRank(s,"6_pick"),d=this.getMatchCountByRank(s,"5_pick"),l=this.getMatchCountByRank(s,"4_pick"),u=this.getMatchCountByRank(s,"3_pick"),g=this.getMatchCountByRank(s,"2_pick"),k=this.getMatchCountByRank(s,"1_pick"),x=i+o+h+d+l+u+g+k,E=s.map(p=>p.turbo_picks||0).reduce(K,0)/10,T=s.map(p=>{const v=(p.pro_pick||0)/n,F=(p.pro_ban||0)/n,L=x,A=p["8_pick"]+p["7_pick"]+p["6_pick"]+p["5_pick"]+p["4_pick"]+p["3_pick"]+p["2_pick"]+p["1_pick"],oe=p["8_win"]+p["7_win"]+p["6_win"]+p["5_win"]+p["4_win"]+p["3_win"]+p["2_win"]+p["1_win"],le=i+o+h,ce=d+l,de=u+g+k,j=p["8_pick"]+p["7_pick"]+p["6_pick"],q=p["5_pick"]+p["4_pick"],U=p["3_pick"]+p["2_pick"]+p["1_pick"],he=p["8_win"]+p["7_win"]+p["6_win"],_e=p["5_win"]+p["4_win"],pe=p["3_win"]+p["2_win"]+p["1_win"];return{...p,hero_id:p.id,heroName:J[p.id]&&J[p.id].localized_name||"",matchCountPro:n,pickBanRatePro:v+F,pickRatePro:v,banRatePro:F,winRatePro:(p.pro_win||0)/p.pro_pick,pickCountPub:A,winCountPub:oe,matchCountPub:L,pickRatePub:A/L,winRatePub:oe/A,pickCountHigh:j,winCountHigh:he,matchCountHigh:le,pickRateHigh:j/le,winRateHigh:he/j,pickCountMid:q,winCountMid:_e,matchCountMid:ce,pickRateMid:q/ce,winRateMid:_e/q,pickCountLow:U,winCountLow:pe,matchCountLow:de,pickRateLow:U/de,winRateLow:pe/U,matchCountTurbo:E,pickRateTurbo:(p.turbo_picks||0)/E,winRateTurbo:(p.turbo_wins||0)/p.turbo_picks}});T.sort((p,v)=>p.heroName&&p.heroName.localeCompare(v.heroName));const R=[this.createTab("pro",n),this.createTab("public",x),this.createTab("turbo",E)],W=R.find(p=>p.key===t),{loading:M,strings:B}=this.props;return e.createElement("div",null,e.createElement(Se,{title:B.header_heroes}),e.createElement("div",null,e.createElement(Ce,{info:t,tabs:R}),W&&W.content(T,Ps({tabType:t,strings:B}),M)))}}const Fs=a=>({data:a.app.heroStats.data,loading:a.app.heroStats.loading,strings:a.app.strings}),$s={dispatchHeroStats:ma,onGetProPlayers:ua},Ws=y(Fs,$s)(Bs);export{Ws as default};
