...
`,Ba=_.div`
  ...
  position: absolute;
  right: 0;
`,Re=a=>{const t=ee(),r=a.mc&&parseInt(a.mc,0)>0;let n=!1;return r&&(n=typeof a.mc=="object"?a.mc[0]:a.mc),e.createElement(Ma,{"data-tip":!0,"data-for":t},e.createElement(Da,{src:H.VITE_IMAGE_CDN+a.img}),r&&e.createElement(Ba,null,n),e.createElement(ae,{id:t,effect:"solid",place:"bottom"},e.createElement(Ue,{ability:a})))};Re.propTypes={mc:m.oneOfType([m.object,m.array,m.string]),img:m.string.isRequired};const Fa=_.div`
  display: flex;
...
`,it=a=>Oa.filter(r=>r.hero_name===a)[0]||{},Be=({heroName:a,skills:t})=>e.createElement(st,null,e.createElement(De,{heroName:a,upgrades:it(a),skills:t}),e.createElement(nt,{"data-for":"aghanim","data-tip":"aghanim"},e.createElement(ke,{src:"/assets/images/dota2/scepter_0.png",alt:"Aghanim's scepter"}),e.createElement(ke,{src:"/assets/images/dota2/shard_0.png",alt:"Aghanim's shard"})));Be.propTypes={heroName:m.string,skills:m.shape({})};const Y=(await ve(()=>import("./abilities-9f924dbe.js"),[])).default,ot=(await ve(()=>import("./index-ec962b73.js").then(a=>a.aA),[])).default,lt=_.div`
  align-items: center;
  display: flex;
  justify-content: center;
  margin-left: -4px;
