...
`,it=a=>Oa.filter(s=>s.hero_name===a)[0]||{},Be=({heroName:a,skills:t})=>e.createElement(rt,null,e.createElement(Me,{heroName:a,upgrades:it(a),skills:t}),e.createElement(nt,{"data-for":"aghanim","data-tip":"aghanim"},e.createElement(ke,{src:"/assets/images/dota2/scepter_0.png",alt:"Aghanim's scepter"}),e.createElement(ke,{src:"/assets/images/dota2/shard_0.png",alt:"Aghanim's shard"})));Be.propTypes={heroName:m.string,skills:m.shape({})};const Y=(await ve(()=>import("./abilities-3865af33.js"),[])).default,ot=(await ve(()=>import("./index-87927ca0.js").then(a=>a.aA),[])).default,lt=_.div`
  align-items: center;
  display: flex;
  justify-content: center;
  margin-left: -4px;
