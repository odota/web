...
export function getLevelOneStats(hero) {
  ...
  return {
    ...
    'attack_rate': round(1.7 / (attack_rate / (1 + ((statsBonuses[primary_attr].attack_speed * agiValue) / 100))) * 100) // ingame representation of attack speed, see also https://dota2.gamepedia.com/Attack_speed  
  }
}
