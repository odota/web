export default {
    ...
    VITE_ENABLE_ADSENSE: import.meta.env.VITE_ENABLE_ADSENSE,
    VITE_ENABLE_DOTACOACH: import.meta.env.VITE_ENABLE_DOTACOACH,
    VITE_ENABLE_GOSUAI: import.meta.env.VITE_ENABLE_GOSUAI,
    VITE_STRIPE_PUBLIC_KEY: import.meta.env.VITE_STRIPE_PUBLIC_KEY || 'pk_live_zFUQR74N5mWV4yZpImL6ouH6',
}
