import {
  heroes as heroData,
  game_mode as gameModeData,
  lobby_type as lobbyTypeData,
} from 'dotaconstants';
...
*/
  ...
  const rankTiers = Object.keys(strings)
    .filter((str) => str.indexOf('rank_tier_') === 0 && str !== 'rank_tier_0')
    .map((str) => {
  ...
  return {
    ...
    key: 'mmr',
      ...
      },
      {
        ...
        value:
          '((public_player_matches.player_slot < 128) = public_matches.radiant_win)',
        alias: 'win',
        key: 'result',
        groupSize: 5,
      },
