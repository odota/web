    ...
    if (resolvedInflictor) {
      ...
      if (ability) {
        if (resolvedInflictor.includes('attribute_bonus')) {
          ...
          image = `${import.meta.env.VITE_IMAGE_CDN}/apps/dota2/images/dota_react/abilities/${resolvedInflictor}.png`;
        }
        ...
        if (customImageIcon.includes(resolvedInflictor)) {
          ...
          image = `${import.meta.env.VITE_IMAGE_CDN}/apps/dota2/images/dota_react/items/${getInflictorImage(resolvedInflictor)}.png`;
        }
