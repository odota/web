...
const singleFields = [{
  ...
  value: 'player_matches.kills',
  key: 'kills',
}, {
  text: strings.heading_deaths,
  value: 'player_matches.deaths',
  key: 'deaths',
}, {
  text: strings.heading_assists,
  value: 'player_matches.assists',
  key: 'assists',
}, {
  text: strings.heading_gold_per_min,
  value: 'player_matches.gold_per_min',
  bucket: 50,
  key: 'gold_per_min',
}, {
  text: strings.heading_xp_per_min,
  value: 'player_matches.xp_per_min',
  bucket: 50,
  key: 'xp_per_min',
}, {
  text: strings.heading_last_hits,
  value: 'player_matches.last_hits',
  bucket: 10,
  key: 'last_hits',
}, {
  text: strings.heading_denies,
  value: 'player_matches.denies',
  key: 'denies',
}, {
  text: strings.heading_hero_damage,
  value: 'player_matches.hero_damage',
  bucket: 1000,
  key: 'hero_damage',
}, {
  text: strings.heading_tower_damage,
  value: 'player_matches.tower_damage',
  bucket: 1000,
  key: 'tower_damage',
}, {
  text: strings.heading_hero_healing,
  value: 'player_matches.hero_healing',
  bucket: 1000,
  key: 'hero_healing',
}, {
  text: strings.heading_level,
  value: 'player_matches.level',
  key: 'level',
}, {
  text: strings.heading_stuns,
  value: 'player_matches.stuns',
  bucket: 1,
  key: 'stuns',
}, {
  text: strings.heading_camps_stacked,
  value: 'player_matches.camps_stacked',
  key: 'camps_stacked',
}, {
  text: strings.heading_lhten,
  value: 'player_matches.lh_t[11]',
  bucket: 10,
  key: 'lh10',
}, {
  text: strings.heading_lhtwenty,
  value: 'player_matches.lh_t[21]',
  bucket: 10,
  key: 'lh20',
}, {
  text: strings.heading_lhthirty,
  value: 'player_matches.lh_t[31]',
  bucket: 10,
  key: 'lh30',
}, {
  text: strings.heading_lhforty,
  value: 'player_matches.lh_t[41]',
  bucket: 10,
  key: 'lh40',
}, {
  text: strings.heading_lhfifty,
  value: 'player_matches.lh_t[51]',
  bucket: 10,
  key: 'lh50',
},
{
  text: strings.th_buybacks,
  value: 'array_length(player_matches.buyback_log, 1)',
  key: 'buybacks',
},
{
  text: strings.th_scans_used,
  value: '(player_matches.actions->>\'31\')::int',
  key: 'scans_used',
},
{
  text: strings.th_glyphs_used,
  value: '(player_matches.actions->>\'24\')::int',
  key: 'glyphs_used',
},
{
  text: strings.th_obs_placed,
  value: 'array_length(player_matches.obs_log, 1)',
  key: 'obs_placed',
},
{
  text: strings.th_sen_placed,
  value: 'array_length(player_matches.sen_log, 1)',
  key: 'sen_placed',
},
{
  text: strings.th_obs_destroyed,
  value: '(player_matches.killed->>\'npc_dota_observer_wards\')::int',
  key: 'obs_destroyed',
},
{
  text: strings.th_sen_destroyed,
  value: '(player_matches.killed->>\'npc_dota_sentry_wards\')::int',
  key: 'sen_destroyed',
},
{
...
},
{
  ...
  value: 'round((0.3 * player_matches.kills + (3 - 0.3 * player_matches.deaths) + 0.003 * (player_matches.last_hits + player_matches.denies) + 0.002 * player_matches.gold_per_min + player_matches.towers_killed + player_matches.roshans_killed + 3 * player_matches.teamfight_participation + 0.5 * player_matches.observers_placed + 0.5 * player_matches.camps_stacked + 0.25 * player_matches.rune_pickups + 4 * player_matches.firstblood_claimed + 0.05 * player_matches.stuns)::numeric, 1)',
  key: 'fantasy_points',
  bucket: 1,
}].map(select => ({
  ...select,
