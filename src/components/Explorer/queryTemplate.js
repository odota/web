...
${radiantMaxGoldAdvantage ? `AND (SELECT matches.radiant_gold_adv[array_upper(matches.radiant_gold_adv, 1)]) <= ${radiantMaxGoldAdvantage.value}` : ''}
${radiantMinGoldAdvantage ? `AND (SELECT matches.radiant_gold_adv[array_upper(matches.radiant_gold_adv, 1)]) >= ${radiantMinGoldAdvantage.value}` : ''}
GROUP BY hero_id
