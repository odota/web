...
const data = [
  {
    type: 'observer',
    image: <img height="24" src={`${import.meta.env.VITE_IMAGE_CDN}/apps/dota2/images/dota_react/items/ward_observer.png`} alt="Observer ward" />,
  },
  {
    type: 'sentry',
    image: <img height="24" src={`${import.meta.env.VITE_IMAGE_CDN}/apps/dota2/images/dota_react/items/ward_sentry.png`} alt="Sentry ward" />,
  },
];
