...
const Styled = styled.div`
  ...
  .events {
    ...
    & .radiant {
      ...
      border-color: transparent transparent ${constants.colorSuccess}
        transparent;
      bottom: 4px;
...
const Timeline = ({
  ...
  match: Match;
  onTeamfightClick?: Function;
  onTeamfightHover?: Function;
  selectedTeamfight?: number;
}) => {
                  ...
                  <mark
                    ...
                    style={{
                      left:
                        obj.time &&
                        `${
                          (100 * (obj.time + preHorn)) /
                            (match.duration + preHorn) -
                          wTeamfight / 2
                        }%`,
                      width: `${wTeamfight}%`,
                  ...
                  >
                    ...
                    {obj.type === 'teamfight' && (
                      <IconBattle
                        ...
                        onMouseEnter={
                          onTeamfightHover && onTeamfightHover(obj.start)
                        }
                        onMouseLeave={
                          onTeamfightHover && onTeamfightHover(null)
                        }
                        data-tip
                        data-for={`event_${i}`}
                          ...
                          {obj.deaths?.map((death) => (
                            <section key={death.key}>
                              ...
                              <span className="goldDelta">
                                {death.gold_delta > 0 ? (
                                  <span className="goldChange goldGot" />
                                ) : (
