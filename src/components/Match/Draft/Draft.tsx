          ...
          <table>
            <tbody className="draft-table">
              {gameMode === 2
                ...
                : draft
                    .sort((a, b) => a.total_time_taken - b.total_time_taken)
                    .map((pb) => (
                      <tr
                        key={pb.order}
                        className={`${radiantOrder.includes(pb.order) ? "radiant" : "dire"} draft-row`}
