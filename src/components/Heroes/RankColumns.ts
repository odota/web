...
export const RankColumns = (props: Props) => {
  return props.tabType === HeroesTabType.PRO
    ? generateProColumns(props.strings)
    : generatePublicColumns(props.strings);
};

const generateProColumns = (strings: GlobalStrings) => {
...
const generatePublicColumns = (strings: GlobalStrings) => {
  const columns = [{
...
const prepareDisplayName = (column: ProColumn | PublicColumn | HeroColumn, strings: GlobalStrings) => {
...
const isHeroColumn = (column: ProColumn | PublicColumn | HeroColumn): column is HeroColumn => {
