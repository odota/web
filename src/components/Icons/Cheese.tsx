...
export default (props: any) => (
  ...
  >
    <path d="M141.4,234.6c0,0,17.4-7.3,39-10s38.7,0.7,38.7,0.7" />
    <path
    ...
    />
    <path d="M269.7,144.9c0,10.1-9.4,19.6-21.1,19.6s-21.4-0.3-21.4-10.4s9.4-18.6,21.2-18.6S269.7,134.8,269.7,144.9z" />
    <path d="M78.3,219c0,10.1-9.9,17.5-21.7,17.5s-17.3-7.4-17.3-17.5c0-10.1,8-20.7,19.8-20.7S78.3,208.9,78.3,219z" />
  </svg>
);
