...
const HeaderBgImg = styled.div<{ img?: string }>`
  ...
  width: 20%;
  background: ${({ img }: any) =>
    `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('${config.VITE_IMAGE_CDN}${img}')`};
    ...
    <Header>
      ...
      <HeaderContent>
        {inflictor && inflictor.startsWith('special_') ? (
          ...
          <img
            id="ability-img"
            src={`${config.VITE_IMAGE_CDN}${ability.img}`}
            alt="Talent Tree"
          />
        )}
    ...
    {(ability.mc || ability.cd) && (
      <Resources>
        {ability.mc && (
          <span>
            <ResourceIcon
              src={`${config.VITE_IMAGE_CDN}/apps/dota2/images/tooltips/mana.png`}
              alt="Mana"
            />
        ...
        {ability.cd && (
          <span>
            <ResourceIcon
              src={`${config.VITE_IMAGE_CDN}/apps/dota2/images/tooltips/cooldown.png`}
              alt="Cooldown"
            />
